...
The file `turtle_ENSGALG00000005902.unaligned.fasta` contains sequences from the genomes of a range of vertebrates. The bioinformatic pipeline used to get these sequences was satisfied that they were all homologous to each other --- i.e. they are all copies of a sequence that existed in the ancestor of these species, and was inherited vertically (with modification) into the species we've included in our analysis.
...
The gene you've aligned comes from a dataset designed to figure out where turtles sit in the tree of life. The three widely accepted options (at least, about a decade ago) were that turtles were one of:
...
Do you notice anything else? Where does the Lizard group sit? Is this what you'd expect? 
